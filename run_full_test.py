...
if __name__=='__main__':
    ...
    kwargs['test_program_type']='qaoa'             # previously just 'qft'             'grover','rca','qft','xor', 'qaoa'
    kwargs['test_conn_G_type']='clos'               # previously just 'clos'
    kwargs['rack_num']=4
    ...
    kwargs['seed']=1     # previously 45541
    kwargs['total_test_num']=1
    kwargs['repeat_num']=1      # previously 100
    ...
    for seed_iter in range(default_kwargs['total_test_num']):
        ...
        for test_scheduler_type in ['baseline_no_ahead','our']:
            ...
            for test_program_type in ['qaoa']:      # ['grover','rca','qft','xor', 'qaoa']
